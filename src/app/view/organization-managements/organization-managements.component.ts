...
@Component({
  ...
  templateUrl: './organization-managements.component.html',
  styleUrls: ['./organization-managements.component.css']
})
export class OrganizationManagementsComponent implements OnInit {
  list: object[] = [
    {id: 1, parentId: 0, title: 'a1', _value: 0, children: [
